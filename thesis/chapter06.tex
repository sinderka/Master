...
The rule found for \texttt{KPM} seams to work for \texttt{SLM} when $m$ is large enough, even though the difference is not so significant as it is for \texttt{KPM}.% larger $m$ tend to need larger $n$ to converge.
